...
export const masterclassConfig: CourseConfig = {
  ...
  title: "Masterclass",
  titleSuffix: "The Specialisations",
  accent: "t-red",
  status: "waitlist",
  ...
  description:
    "Twelve live lectures with Dr. Sunita Tandulwadkar. Covering the hardest cases in reproductive medicine, from recurrent implantation failure and pregnancy loss to diminished ovarian reserve and severe male factor. Designed for the doctor working where protocols run out and judgment takes over",
  badges: ["12 Lectures", "Interactive Q&A", "Case-Driven", "Certificate"],
  videoId: "JSS-eFMv_cs",
  videoPoster: "/images/MasterclassVid.webp",
  videoBadgeLabel: "Masterclass Series · Intro",
  primaryCta: { type: "notify-modal", target: "", label: "Notify Me When Masterclass Opens" },

  lectureEyebrow: "The Curriculum",
  lectureTitle: "Twelve lectures, where the textbook stops being useful.",
  ...
  lectures: [
    { id: "lecture-1",  label: "Lecture One",    no: "01", title: "Endometriosis and Infertility — Optimizing IVF Results in Endometriosis",                body: "The decision tree the patient is waiting for. When to operate, when to skip surgery and go straight to IVF, and how to read the disease stage against the patient's age and fertility window. The case where a surgical decision changes everything that follows.",                                                                                                                         duration: "Live", thumb: LECTURE_THUMBS[0] },
    { id: "lecture-2",  label: "Lecture Two",    no: "02", title: "Unexplained Infertility — Redefining Idiopathic Infertility through High-Resolution Diagnostics", body: "The diagnosis that is not a diagnosis. The structured workup that catches what standard testing misses, the implicit causes that hide in plain sight, and the treatment ladder for couples whose tests are normal but pregnancy is not happening.",                                                               duration: "Live", thumb: LECTURE_THUMBS[1] },
    { id: "lecture-3",  label: "Lecture Three",  no: "03", title: "Recurrent Implantation Failure",                                                           body: "The case file that has moved through three specialists. How to investigate RIF systematically, the endometrial, embryonic, and immunological causes that need to be ruled in or out, and the protocol adjustments that change a failure pattern into a successful cycle.",                                                                                                     duration: "Live", thumb: LECTURE_THUMBS[2] },
    { id: "lecture-4",  label: "Lecture Four",   no: "04", title: "Recurrent Pregnancy Losses — A Masterclass in Etiology, Diagnosis and Precision Management", body: "The patient who has miscarried more than once and needs answers. The workup that finds the cause in roughly half of cases, the management for the half where no cause is found, and the support framework that holds the patient through the next cycle.",                                                              duration: "Live", thumb: LECTURE_THUMBS[3] },
    { id: "lecture-5",  label: "Lecture Five",   no: "05", title: "Diminished Ovarian Reserve — Strategy, Protocols, Expectations",                           body: "The diagnosis that takes the hardest emotional toll. How to use AMH and AFC honestly in patient counselling, the protocols that maximise the cycle without overpromising, and when to introduce the donor egg conversation without losing the patient's trust.",                                                                                                                   duration: "Live", thumb: LECTURE_THUMBS[4] },
    { id: "lecture-6",  label: "Lecture Six",    no: "06", title: "Ovarian Rejuvenation: Beyond Stem Cells & PRP",                                            body: "The emerging field of regenerative reproductive medicine. Intraovarian PRP, stem cell approaches, and other biological therapies that are entering the clinical conversation. Patient selection, evidence base, expectations management, and how to position these options ethically alongside standard care.",                                                           duration: "Live", thumb: LECTURE_THUMBS[5] },
    { id: "lecture-7",  label: "Lecture Seven",  no: "07", title: "Myoma and Infertility",                                                                    body: "The fibroid that is contributing to infertility, and the one that is incidental. How to read location, size, and submucosal involvement against fertility outcomes, and the surgical and non-surgical decisions for patients trying to conceive.",                                                                                                                                        duration: "Live", thumb: LECTURE_THUMBS[6] },
    { id: "lecture-8",  label: "Lecture Eight",  no: "08", title: "Azoospermia — Pathway + Sperm Retrieval Overview",                                         body: "The clinical pathway when the semen analysis is not just abnormal but catastrophic. Obstructive versus non-obstructive azoospermia, surgical retrieval options, ICSI considerations, and the counselling conversation that prepares the couple for the realistic path forward.",                                                                                                 duration: "Live", thumb: LECTURE_THUMBS[7] },
    { id: "lecture-9",  label: "Lecture Nine",   no: "09", title: "PCOS and Fertility",                                                                       body: "The most common endocrine disorder in reproductive medicine, and the one most misread in everyday practice. How to phenotype the patient correctly, when standard ovulation induction is the answer and when it is not, and the metabolic considerations that decide long-term outcomes.",                                                                                                     duration: "Live", thumb: LECTURE_THUMBS[8] },
    { id: "lecture-10", label: "Lecture Ten",    no: "10", title: "Refractory Endometrium",                                                                   body: "Coming soon.",                                                                                                                                                                                                                                                                                                                                                                         duration: "Live", thumb: LECTURE_THUMBS[9] },
    { id: "lecture-11", label: "Lecture Eleven", no: "11", title: "Obesity and Infertility",                                                                  body: "Coming soon.",                                                                                                                                                                                                                                                                                                                                                                         duration: "Live", thumb: LECTURE_THUMBS[10] },
    { id: "lecture-12", label: "Lecture Twelve", no: "12", title: "Advances in ART",                                                                          body: "Coming soon.",                                                                                                                                                                                                                                                                                                                                                                         duration: "Live", thumb: LECTURE_THUMBS[11] },
  ],
  ...
  ribbon: {
    ...
    headlineAccent: "Twelve-Lecture Masterclass Program",
  ...
  perks: [
    "Twelve live lectures with Dr. Sunita",
  ...
  panelCta: { type: "notify-modal", target: "", label: "Notify Me When Masterclass Opens" },
};

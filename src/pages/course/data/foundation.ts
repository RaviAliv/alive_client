...
export const foundationConfig: CourseConfig = {
  ...
  lectures: [
    { id: "lecture-1", label: "Lecture One",   no: "01", title: "HPO Axis: From Physiology to Precision",                             body: "The full story of how an oocyte matures over 300 days, the hormonal signal it answers to, and the clinical decisions resting on the biology in front of you.", duration: "Live", thumb: LECTURE_THUMBS[0], detailPath: "/course/foundation/lecture/01" },
    { id: "lecture-2", label: "Lecture Two",   no: "02", title: "The Endocrine Architecture of Follicular Phase — From Endocrinology to Survival of the Fittest Follicle",                                                              body: "The hormonal cascade of the follicular phase — FSH thresholds, granulosa cell signalling, and the selection of the dominant follicle read as a clinical system.",   duration: "Live", thumb: LECTURE_THUMBS[1], detailPath: "/course/foundation/lecture/02" },
    { id: "lecture-3", label: "Lecture Three", no: "03", title: "Ovulation: From Follicle Destiny to Follicle Rupture — The 350-Day Symphony",    body: "From molecular dynamics to clinical application. Why ovulation works the way it does, when to trigger, and how to adapt when the textbook playbook breaks down.",   duration: "Live", thumb: LECTURE_THUMBS[2], detailPath: "/course/foundation/lecture/03" },
    { id: "lecture-4", label: "Lecture Four",  no: "04", title: "Luteal Phase: Physiology, Endocrinology and Clinical Importance",                                body: "The corpus luteum as a diagnostic compass. Current evidence on luteal support — when it is mandatory, when it is individualised, and when continuing it is doing nothing.", duration: "Live", thumb: LECTURE_THUMBS[3], detailPath: "/course/foundation/lecture/04" },
    { id: "lecture-5", label: "Lecture Five",  no: "05", title: "Spermatogenesis: From Germ Cell Development to Semen Analysis, Genetics to Clinical Terminologies",                    body: "Implantation as a conversation between embryo and endometrium. How endometrial receptivity and embryonic signalling work, and what changes when they do not.",     duration: "Live", thumb: LECTURE_THUMBS[4], detailPath: "/course/foundation/lecture/05" },
    { id: "lecture-6", label: "Lecture Six",   no: "06", title: "Implantation: From Endometrial Receptivity to Endometrium–Embryo Dialogue",                                                    body: "Spermatogenesis takes seventy-four days. What the semen analysis reports, which parameters predict outcome, when to refer, and when the male factor has already set the ceiling.", duration: "Live", thumb: LECTURE_THUMBS[5], detailPath: "/course/foundation/lecture/06" },
  ],
  ...
  fullCurriculum: [
    { num: "01", title: "HPO Axis: From Physiology to Precision",                           body: "The full story of how an oocyte matures over 300 days, from the first hypothalamic signal through follicular recruitment to ovulation. The biology that every clinical decision sits above, rebuilt from first principles." },
    { num: "02", title: "The Endocrine Architecture of Follicular Phase — From Endocrinology to Survival of the Fittest Follicle",                                                        body: "The hormonal cascade of the follicular phase in clinical detail — FSH thresholds, granulosa cell aromatase activity, dominant follicle selection, and the estradiol dynamics that set up the LH surge." },
    { num: "03", title: "Ovulation: From Follicle Destiny to Follicle Rupture — The 350-Day Symphony", body: "From molecular dynamics to clinical application. Why ovulation works the way it does, when to trigger, what makes a trigger succeed or fail, and how to adapt the decision for the specific patient and cycle in front of you." },
    { num: "04", title: "Luteal Phase: Physiology, Endocrinology and Clinical Importance",                          body: "The corpus luteum as a diagnostic compass, not a checkbox. Current evidence on luteal phase support in ART — when it is mandatory, when it is individualised, when continuing past a positive test is doing nothing." },
    { num: "05", title: "Spermatogenesis: From Germ Cell Development to Semen Analysis, Genetics to Clinical Terminologies",             body: "Implantation is not a timing problem. It is a conversation between the embryo and the endometrium. How endometrial receptivity and embryonic signalling work, and why understanding this changes the way you approach implantation failure." },
    { num: "06", title: "Implantation: From Endometrial Receptivity to Endometrium–Embryo Dialogue",                                              body: "Male factor accounts for half of all infertility. This lecture covers spermatogenesis from stem cell to ejaculated sperm, how to interpret the semen analysis as a clinical document, and the decisions that follow when the result is abnormal." },
  ],
